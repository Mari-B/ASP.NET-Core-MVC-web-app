...
namespace MVCUniversity.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,SubjectMatter,Description,StartingDate")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,SubjectMatter,Description,StartingDate")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
